...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void FollowRocket_StartObject_mB6F76FA91DF93A6D04B52FE837AFA2E0E77D00F3 (FollowRocket_t61BC84F1D599DF607C7EF5719B845BAC2B14FF16* __this, GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* ___0_rocketTrail, float ___1_speed, const RuntimeMethod* method) 
{
	...
	memset((&V_4), 0, sizeof(V_4));
	{
		...
		L_3 = Quaternion_get_eulerAngles_m2DB5158B5C3A71FD60FC8A6EE43D3AAA1CFED122_inline((&V_4), NULL);
		V_0 = L_3;
		float* L_4 = (float*)(&(&V_0)->___y);
		float* L_5 = L_4;
		float L_6 = *((float*)L_5);
		*((float*)L_5) = (float)((float)il2cpp_codegen_subtract(L_6, (90.0f)));
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_7 = ___0_rocketTrail;
		...
		__this->___createdRocketTrail = L_12;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___createdRocketTrail), (void*)L_12);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_13 = __this->___createdRocketTrail;
		NullCheck(L_13);
		...
		L_17 = MinMaxCurve_op_Implicit_m133028E91CF2F823F5E20F6B19A3332A02404086((52.0f), NULL);
		MainModule_set_startSpeed_mE6041E4BA54F01117AF6B81B1E53C5C9C669AC75((&V_2), L_17, NULL);
		MinMaxCurve_t812D571297EED6498776CC58949A42B172E60E23 L_18;
		L_18 = MinMaxCurve_op_Implicit_m133028E91CF2F823F5E20F6B19A3332A02404086((100.0f), NULL);
		MainModule_set_startLifetime_mDFC2433853CB12C0C93C8BF16FEDB4EA2E0B3514((&V_2), L_18, NULL);
		...
		ShapeModule_set_position_mA9693D2FF3D1E8266D2B7932E6AF22F5E121D3CE((&V_3), L_22, NULL);
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MoveEnemyTank_FixedUpdate_mEE5CB0406A5DDA2C8B49D091AE9BD5FDB1032B40 (MoveEnemyTank_t311A987A719828A12D372AA80B67C787CB741EAB* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->___fire = L_11;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___fire), (void*)L_11);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_12 = __this->___smoke;
		...
		__this->___smoke = L_17;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___smoke), (void*)L_17);
		__this->___isHit = (bool)0;
	}

IL_0079:
	{
		bool L_18 = __this->___isHit;
		if (L_18)
		{
			goto IL_008f;
		}
	...
	{
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_19 = __this->___fire;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_20;
...
IL_0090:
	...
	{
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_22 = __this->___fire;
		NullCheck(L_22);
		...
		__this->___particleConfig = L_23;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___particleConfig), (void*)L_23);
		ParticleSystem_tB19986EE308BD63D36FB6025EEEAFBEDB97C67C1* L_24 = __this->___particleConfig;
		NullCheck(L_24);
		...
		L_26 = MinMaxCurve_op_Implicit_m133028E91CF2F823F5E20F6B19A3332A02404086((5.0f), NULL);
		MainModule_set_startSize_m44C3A39EAF1AE9A526A126D93160128223BE827B((&V_2), L_26, NULL);
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_31 = __this->___smoke;
		NullCheck(L_31);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ShootGun_createTankBullet_mBCC800F89163DBCA1485898622DA0C854D38591E (ShootGun_tA322A9E509A593A5DD94F2EC047F5911FC9A1B2A* __this, const RuntimeMethod* method) 
{
	...
	memset((&V_8), 0, sizeof(V_8));
	{
		...
		*((float*)L_4) = (float)((float)il2cpp_codegen_add(L_5, (90.0f)));
		...
		NullCheck(L_34);
		Rigidbody_AddForce_m7A3EEEED21F986917107CBA6CC0106DCBC212198(L_34, L_38, NULL);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_39 = V_2;
		Object_Destroy_m064F2A066491D2DC4FFCFBDBE5FCFFB807A04436(L_39, (1.0f), NULL);
		FollowRocket_t61BC84F1D599DF607C7EF5719B845BAC2B14FF16* L_40 = V_6;
		NullCheck(L_40);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_41 = L_40->___createdRocketTrail;
		Object_Destroy_m064F2A066491D2DC4FFCFBDBE5FCFFB807A04436(L_41, (2.5f), NULL);
		return;
	}
}
